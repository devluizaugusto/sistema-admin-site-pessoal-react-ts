                    ...
                    <tr key={index}>
                        {columns.map((column, columnIndex) => (
                            ...
                            <td key={columnIndex} className={styles.td}>
                                <img src={item[column.accessor] as string} className={styles.image} alt="image" />
                            </td>
                            :
                        ...
                        {(handleEdit || handleDelete) && (
                            <td className={styles.td}>
                                {handleEdit && <Button onClick={() => handleEdit(item)} gray>Editar</Button>}
                                {handleDelete && <Button onClick={() => handleDelete(item)} gray>Deletar</Button>}
                            </td>
                        )}
                    </tr>
                ))}
